...
export default function AdminDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'tickets' | 'agents' | 'analytics'>('analytics');
  ...
  const stats = useMemo(() => {
    ...
    const deptStats = Object.values(tickets.reduce((acc: any, t) => {
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="border-none shadow-sm">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Currently handled</p>
              </CardContent>
            </Card>
            <Card className="border-none shadow-sm">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <div className="flex gap-2">
                ...
                <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Technical Support">Technical</SelectItem>
                    <SelectItem value="Billing Inquiry">Billing</SelectItem>
                    <SelectItem value="General Inquiry">General</SelectItem>
                    <SelectItem value="Account Management">Account</SelectItem>
